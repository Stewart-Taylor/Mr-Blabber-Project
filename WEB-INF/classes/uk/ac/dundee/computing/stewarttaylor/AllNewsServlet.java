...
public class AllNewsServlet extends HttpServlet
 {
		...
		public void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, java.io.IOException 
		{
			...
			RequestDispatcher dispatcher = req.getRequestDispatcher("/allnews.jsp");
		...
		private MessageBean getMessage(int userID)
		{
			...
			rs = st.executeQuery("select * from message join user on user.user_id = message.user_id ORDER BY message_id DESC ");
